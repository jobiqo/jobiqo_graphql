...
namespace Drupal\jobiqo_graphql\Plugin\GraphQL\DataProducer\Field;
...
use Drupal\jobiqo_graphql\GraphQL\Buffers\EntityRevisionBuffer;
...
class EntityReferenceRevisions extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function resolve(EntityInterface $entity, string $field, $language = NULL, array $bundles = NULL, RefinableCacheableDependencyInterface $metadata) {
